...
@Composable
private fun SuccessContent(recommendations: List<AiRecommendation>) {
...
@Composable
private fun RecommendationCard(rec: AiRecommendation) {
    Surface(
        modifier = Modifier.fillMaxWidth(),
